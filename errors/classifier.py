...
ERROR_SUGGESTIONS = {
    ErrorType.AUTH_ERROR: (
        ...
        "Check your API key in Settings. Make sure it's valid and has proper permissions.",
        False, 0
    ),
    ErrorType.INVALID_API_KEY: (
        "Invalid API key",
        "The API key is incorrect or expired. Please verify your credentials in Settings.",
        False, 0
    ),
